...
<body>
    ...
    if (!$conn) {
        ...
        $sql = "SELECT * FROM users WHERE email = '$email' OR name ='$fullName'";
        ...
        if($rowCount1>0){
            array_push($errors,"*Password already used,try with a different password");
        }
        if (count($errors)>0) {
         ...
         $psql = "INSERT INTO users (name, email, password) VALUES ('$fullName','$email','$Password' );";
        ...
        <form action="registration.php" method="post">
            ...
            <input type="text" name="roll_no" placeholder="Enter your name" class="inp" required /><br />

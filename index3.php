...
function sendDataToServer(dataArray) {
  ...
  const phpFile = "insert_data3.php"; // Replace "insert_data.php" with your PHP script filename
...
<body onload="getUserLocation()">
    ...
    <div class="container">
        <h1>Welcome to MHB2 BUS DRIVER Dashboard</h1>
         <h1>Heyyy  </h1>
   <p id="coordinates"></p>
